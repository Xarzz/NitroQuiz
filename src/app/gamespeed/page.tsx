    ...
    useEffect(() => {
        ...
        const loadAssets = async () => {
            ...
            const assetList = [
                ...
                // --- City Assets (New) ---
                // Tempat Sampah
                { name: 'trash_left', src: '/assets/material/tempat_sampah/1.png' },
                { name: 'trash_right', src: '/assets/material/tempat_sampah/2.png' },
                // Semak
                ...
                // Pohon
                { name: 'pohon_1', src: '/assets/material/pohon/1.png' },
                { name: 'pohon_2', src: '/assets/material/pohon/2.png' },
                { name: 'pohon_3', src: '/assets/material/pohon/3.png' },
                { name: 'pohon_4', src: '/assets/material/pohon/4.png' },
                // Pembatas Jalan
                { name: 'cone', src: '/assets/material/pembatas_jalan/1penghalang.png' },
                { name: 'barrier', src: '/assets/material/pembatas_jalan/1roadbarrier.png' },
                // Bangku
